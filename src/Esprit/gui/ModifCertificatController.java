 ...
 * @author User-DELL
 */
public class ModifCertificatController implements Initializable {
 ...
 // TODO
     ...
     JFXTreeTableColumn<Esprit.entities.Certificat, String> titre_certif = new JFXTreeTableColumn<>("titre_certif");
        ...
        titre_certif.setOnEditCommit((CellEditEvent<Esprit.entities.Certificat, String> t) -> {
        ...
        date_certif.setOnEditCommit((CellEditEvent<Esprit.entities.Certificat, String> t) -> {
            int idd = t.getTreeTableView().getTreeItem(t.getTreeTablePosition().getRow()).getValue().getId_certif();
            String newValue = t.getNewValue();
